...
//                );
        ...
        SingleOutputStreamOperator<WaterSensor> sensorDS = bsEnv.fromSource(dataGeneratorSource, WatermarkStrategy
                .<WaterSensor>forBoundedOutOfOrderness(Duration.ofSeconds(3))
...
//方法1 写入hive
//        statementSet.addInsert("t1",sensorTable);
...
//        tableEnv.executeSql("select * from t1 limit 1").print();
        tableEnv.toChangelogStream(sensorTable ).print("s1");
